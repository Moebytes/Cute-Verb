...
public:
    ParameterID mix;
    ParameterID decay;
    ParameterID predelay;
    ParameterID size;
    ParameterID width;
    ParameterID damping;
    ParameterID diffusion;
    ParameterID lowcut;
    ParameterID highcut;
    ...
    static auto loadFromJSON() -> ParameterIDs {
        ...
        parameterIDs.decay = getParameter("decay");
        parameterIDs.predelay = getParameter("predelay");
        parameterIDs.size = getParameter("size");
        parameterIDs.width = getParameter("width");
        parameterIDs.damping = getParameter("damping");
        parameterIDs.diffusion = getParameter("diffusion");
        parameterIDs.lowcut = getParameter("lowcut");
        parameterIDs.highcut = getParameter("highcut");
