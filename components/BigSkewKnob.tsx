...
const BigSkewKnob: React.FunctionComponent<Props & WithJUCESkewSliderProps> = ({label, parameterID, 
    ...
    if (!displayFunction) {
        displayFunction = (value: number) => `${denormalizeValue(value).toFixed(2)} s`
    }
...
export default withJuceSkewSlider(BigSkewKnob)